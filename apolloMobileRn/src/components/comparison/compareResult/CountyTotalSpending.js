...
class CountyTotalSpending extends Component {
	render() {
		return (
			<View
				style={{
					backgroundColor: Colors.CountyTotalSpendingBackgroundColor,
			...
			>
				...
				>
					{localizedText['TotalCountySpending(First5)']}
				</Text>
...
export default CountyTotalSpending;
