...
class DistrictTotalSpending extends Component {
	render() {
		return (
			<View
				style={{
					backgroundColor: Colors.DistrictTotalSpendingBackgroundColor,
			...
			>
				...
				>
					{localizedText['DistrictTotalSpending(First5)']}
				</Text>
...
export default DistrictTotalSpending;
