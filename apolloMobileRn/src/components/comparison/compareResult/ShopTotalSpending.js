...
class ShopTotalSpending extends Component {
	render() {
		return (
			<View
				style={{
					backgroundColor: Colors.ShopTotalSpendingBackgroundColor,
			...
			>
				...
				>
					{localizedText['ShopTotalSpending(First5)']}
				</Text>
...
export default ShopTotalSpending;
